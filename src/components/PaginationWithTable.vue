    ...
    <div class="footer-pagination d-flex justify-content-between">
      ...
      <nav aria-label="Page navigation example">
        <ul class="pagination m-0">
          <li class="page-item">
            <a class="page-link rounded-0" href="#" aria-label="Previous" @click.prevent="goToPage(currentPage - 1)"
              :disabled="currentPage === 1">
              <span aria-hidden="true">&laquo;</span>
            </a>
          </li>
          <li v-for="page in pages" :key="page" class="page-item">
            <a class="page-link" href="#" @click.prevent="goToPage(page)" :class="{ active: page === currentPage }">{{
              page }}</a>
          </li>
          <li class="page-item">
            <a class="page-link rounded-0" href="#" aria-label="Next" @click.prevent="goToPage(currentPage + 1)"
